...
class extract(Command):
    ...
    def execute(self):
        ...
        marked_file = marked_files[0]
        au_flags = ['-x']

        descr = 'extracting: ' + os.path.basename(marked_file.path)
        obj = CommandLoader(args=['aunpack'] + au_flags + [marked_file.path],
                            descr=descr)
